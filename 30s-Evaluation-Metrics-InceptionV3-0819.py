...
lstm_best_model.save('LabTestModel30s/InceptionV3-LSTM_Best_Model(224-25s).h5')
...
# 保存图像
plt.savefig(f'{save_path}/InceptionV-30s - Receiver Operating Characteristic.png')
...
# 保存图像
plt.savefig(f'{save_path}/InceptionV3-30s - Precision-Recall curve.png')
