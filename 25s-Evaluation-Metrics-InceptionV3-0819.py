...
lstm_best_model.save('ModelROCPlots/InceptionV3-LSTM_Best_Model(224-25s).h5')
...
# 保存图像
plt.savefig(f'{save_path}/InceptionV3 - Receiver Operating Characteristic.png')
...
plt.title('InceptionV3 - Precision-Recall curve')
plt.legend(loc="lower left")

save_path = '/Users/yuanyi/学习/毕业论文/毕业论文题目/Pycharm_Code/ModelROCPlots'
# 保存图像
plt.savefig(f'{save_path}/InceptionV3 - Precision-Recall curve.png')
