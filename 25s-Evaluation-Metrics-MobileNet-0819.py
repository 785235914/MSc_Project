...
lstm_best_model.save('ModelROCPlots/MobileNet-LSTM_Best_Model(224-25s).h5')
...
# 保存图像
plt.savefig(f'{save_path}/MobileNet - Receiver Operating Characteristic.png')
...
save_path = '/Users/yuanyi/学习/毕业论文/毕业论文题目/Pycharm_Code/ModelROCPlots'
# 保存图像
plt.savefig(f'{save_path}/MobileNet - Precision-Recall curve.png')
...
# MobileNet
# Train Loss:  2.2499843055356905e-07
# Train Accuracy:  1.0
# Validation Loss:  0.9933282136917114
# Validation Accuracy:  0.9008746147155762
# Accuracy:  0.9008746355685131
# F1 Score:  0.908108108108108
# AUC:  0.9016472203157171
