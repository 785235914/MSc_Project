...
model_path = '/Users/yuanyi/学习/毕业论文/毕业论文题目/Pycharm_Code/TestModel'
...
lstm_best_model.save('ModelROCPlots/InceptionResNetV2-LSTM_Best_Model(224-25s).h5')
...
plt.title('InceptionResNetV2 - Receiver Operating Characteristic')
plt.legend(loc="lower right")

save_path = '/Users/yuanyi/学习/毕业论文/毕业论文题目/Pycharm_Code/ModelROCPlots'
# 保存图像
plt.savefig(f'{save_path}/InceptionResNetV2-2 - Receiver Operating Characteristic.png')
...
plt.title('InceptionResNetV2 - Precision-Recall curve')
plt.legend(loc="lower left")

save_path = '/Users/yuanyi/学习/毕业论文/毕业论文题目/Pycharm_Code/ModelROCPlots'
# 保存图像
plt.savefig(f'{save_path}/InceptionResNetV2-2 - Precision-Recall curve.png')
...
# Best Transfer-CNN accuracy:  0.916139936447143
#
# Accuracy:  0.8279883381924198
# F1 Score:  0.8409703504043127
# AUC:  0.8413793103448275
...
# Train Loss:  6.639252387685701e-05
# Train Accuracy:  1.0
# Validation Loss:  0.8454181551933289
# Validation Accuracy:  0.8600583076477051
# Best NASNetMobile-25s parameters:  {'units': 256, 'recurrent_dropout': 0.2, 'optimizer': 'rmsprop', 'learning_rate': 0.001, 'epochs': 100, 'dropout': 0.2, 'batch_size': 128, 'activation': 'sigmoid'}
# Accuracy:  0.8600583090379009
# F1 Score:  0.8750000000000001
# AUC:  0.8562491430138489
